...
export default function Page() {
  ...
  const handleCalClick = () => {
    ...
    if (
      ...
      Swal.fire({
        icon: "error",
        title:
          "กรุณาใส่น้ำหนักและส่วนสูงให้ถูกต้อง\n(ส่วนสูง: 0-300 cm, น้ำหนัก: 0-200 kg)",
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl text-center mt-2 text-gray-600">คำนวณค่า BMI</h3>
